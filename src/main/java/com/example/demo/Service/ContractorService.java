...
public class ContractorService {
    ...
    public List<ServiceOrderPresentation> getContractors(List<Contractor> contractors) {
        ...
        for (Contractor contractor1 : contractors) {
            ...
            serviceOrderPresentation.setContractorType(contractor1.getContractorType().getContractorType());
            ...
            serviceOrderPresentation.setCountryName(contractor1.getCountry().getCountryName());
...
//        System.out.println(contractor.getSkills());
//
//
//
//
        for(ContractorSkill skill:contractorSkills)
        {

//            serviceOrderPresentation.setSkill(contractor.getContractorSkills());
