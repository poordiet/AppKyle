    ...
    public List<CustomerPresentation> getCustomerPresentation(List<CustomerSite> customerSites){
        ...
        for (CustomerSite customerSite1:customerSites) {
           ...
           /* String svcName = new String();
            ...
            Set<Contact> contacts = customerSite1.getContacts();
            ...
            for(Contact contact1:contacts)
            {
                ...
                customerPresentation.setContactFname(contact1.getContactFname());
                customerPresentation.setContactLname(contact1.getContactLname());
               customerPresentation.setContactPhone(contact1.getContactPhone());
...
//  !!!      customerSite1.setContacts(contact1);
        ...
        contact1.setCustomerSite(customerSite1);
